            ...
            <div class="space-y-4">
             ...
             <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea type="text" name="description" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                </div>
